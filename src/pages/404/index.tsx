    ...
    <Layout>
      <header className="mx-auto flex min-h-screen w-full max-w-screen-md items-center justify-center">
        <div className="flex h-8 items-center space-x-4">
          <h1 className="font-mono text-sm text-muted-foreground animate-in slide-in-from-top md:text-xl">
            404
          </h1>

          <Separator orientation="vertical" />

          <p className="font-mono text-sm text-muted-foreground animate-in slide-in-from-bottom md:text-xl">
            {t('page-not-found')}
          </p>
        </div>
      </header>
