...
description: Use Cloudflare Workers and React to make a Basic Typeahead Search for Pokedex.
...
![cloudflare-workers-homepage](src/assets/media/cloudflare-workers-homepage.png "cloudflare-workers-homepage")

In the onboarding screen, select a unique subdomain for our workers.

![setting-up-custom-subdomain](src/assets/media/setting-up-custom-subdomain.jpg "setting-up-custom-subdomain")
...
![wrangler-login-terminal](src/assets/media/wrangler-login-terminal.png "wrangler-login-terminal")

This will open up a page on your browser where you can authorise the wrangler.

![wrangler-login-browser](src/assets/media/wrangler-login-browser.jpg "wrangler-login-browser")
...
![wrangler-generate-template](src/assets/media/wrangler-generate-template.jpg "wrangler-generate-template")
...
![typeahead-search-final](src/assets/media/final-product.png "typeahead-search-final")
