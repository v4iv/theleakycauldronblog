...
export function TypographyH2({children, className}: {children: React.ReactNode, className?: string}) {
  return (
    <h2 className={cn("scroll-m-20 text-3xl font-bold tracking-tight transition-colors first:mt-0", className)}>
      {children}
    </h2>
  )
}
...
export function TypographyH3({children, className}: {children: React.ReactNode, className?: string}) {
  return (
    <h3 className={cn("scroll-m-20 text-2xl font-bold tracking-tight", className)}>
      {children}
    </h3>
  )
}
...
export function TypographyP({children, className}: {children: React.ReactNode, className?: string}) {
  return (
    <p className={cn("leading-7 font-light [&:not(:first-child)]:mt-6", className)}>
      {children}
    </p>
  )
}
...
export function TypographyLead({children, className}: {children: React.ReactNode, className?: string}) {
  return <p className={cn("text-lg md:text-xl text-muted-foreground", className)}>{children}</p>
}
