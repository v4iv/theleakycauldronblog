...
const Socials = (props) => {
  ...
  return (
    <div className='db dtc-ns black-70 tc tr-ns v-mid'>
      <a
        href={`feed:https://theleakycauldronblog.com${siteRss}`} className='link hover-orange dib mr3 black-70'
        title='The Leaky Cauldron Blog RSS Feed'
        target='_blank'
        rel='noopener nofollow noreferrer'
      >
        <svg
          className='db w2 h2' role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'
          fill='currentColor'
        >
      ...
      <a
        href='https://instagram.com/theleakycauldronblog' className='link hover-pink dib mr3 black-70'
        title='The Leaky Cauldron Blog on Instagram'
        target='_blank'
        rel='noopener nofollow noreferrer'
      >
        <svg
          ...
          fill='currentColor'
        >
          <title>The Leaky Cauldron Blog Instagram</title>
      ...
      >
        <svg
          className='db w2 h2' data-icon='twitter' viewBox='0 0 32 32'
          fill='currentColor'
        >
