...
const Socials = (props) => {
  ...
  return (
    <div className="db dtc-ns black-70 tc tr-ns v-mid">
      <a
        href={`feed:https://theleakycauldronblog.com${siteRss}`}
      ...
      <a
        href="https://instagram.com/theleakycauldronblog"
      ...
      <a
        href="https://twitter.com/vaibhaved"
      ...
      <a
        ...
        title="Vaibhav Sharma on Github"
        target="_blank"
        rel="noopener nofollow noreferrer"
      >
        <svg
